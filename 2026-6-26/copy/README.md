# PacificLight Website Agent 配置说明
...
- `agents/website_live_chat_agent_prompt.md`：收口版，可直接粘贴到平台
...
- `residential_signup.zip`
- `identity_verification.zip`
- `account_update.zip`
- `quote_calculation.zip`
- `service_case.zip`
- `billing_query.zip`
- `invoice_send.zip`
- `email_send.zip`
