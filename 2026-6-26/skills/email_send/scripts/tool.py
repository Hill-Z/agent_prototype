...
PDF_BILL_LINK = "https://espreview.s4.udesk.cn/onlinePreview?url=%3D%3D"
...
def _money_status_note(payment_status: str, due_date: str, language: str = "en") -> str:
    ...
    if due_date:
        return f"请在 {due_date} 前完成付款，以避免产生 Late Payment Charge。"
    return "请在账单到期日前完成付款。"
...
def _bill_email_html(language: str = "en", **data) -> str:
    ...
    if _is_en(language):
        ...
        rows = [
            ...
            ("本期用电量", e("consumption")),
            ("电费 Energy Charge", e("energy_charge")),
            ("市场支持服务费 MSS Charge", e("mss_charge")),
            ("电表服务费 Metering Charge", e("metering_charge")),
            ("碳税 Carbon Tax", e("carbon_tax")),
            ("小计 Subtotal", e("subtotal")),
            ("GST 9%", e("gst")),
            ("Late Payment Charge", e("late_payment_charge")),
            ("应付总额 Total Amount Due", e("total_amount_due")),
        ]
    row_html = "".join(
