...
export function CardManagementPage({ onBack, onOpenSkills, onOpenTools }: {
  onBack: () => void;
  onOpenSkills: () => void;
  onOpenTools: () => void;
}) {
  return <div className="management-body cards-body">
    <ManagementSidebar active="卡片" onBack={onBack} onOpenSkills={onOpenSkills} onOpenTools={onOpenTools} onOpenCards={() => undefined} />
